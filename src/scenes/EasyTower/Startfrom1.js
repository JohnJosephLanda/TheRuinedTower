...
export default class EasyStartfrom1 extends Phaser.Scene
{
    // player;
    preload()
    {
    ...
    create()
    {
        ...
        .on('pointerdown', () => { 
            let paused = true
            audio.pause();
            this.scene.launch("pauseScreen",{scene:"easystartingPointfrom1"})
            this.scene.sleep("easystartingPointfrom1")
