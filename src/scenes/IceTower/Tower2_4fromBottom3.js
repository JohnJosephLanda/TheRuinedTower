...
export default class IceTower2_4fromBottom3 extends Phaser.Scene
{
    // player;
    preload()
    {
    ...
    create()
    {
        ...
        .on('pointerdown', () => { 
            let paused = true
            this.scene.launch("pauseScreen",{scene:"icetower2_4frombottom3"})
            this.scene.sleep("icetower2_4frombottom3")
