...
export default class IceTower5fromTop extends Phaser.Scene
{
    // player;
    preload()
    {
    ...
    create()
    {
        ...
        .on('pointerdown', () => { 
            let paused = true
            this.scene.launch("pauseScreen",{scene:"icetower5fromtop"})
            this.scene.sleep("icetower5fromtop")
