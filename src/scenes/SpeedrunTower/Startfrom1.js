...
export default class SpeedrunStartfrom1 extends Phaser.Scene
{
    // player;
    preload()
    {
    ...
    create()
    {
        ...
        .on('pointerdown', () => { 
            let paused = true
            audio.pause();
            this.scene.launch("pauseScreen",{scene:"speedrunstartingPointfrom1"})
            this.scene.sleep("speedrunstartingPointfrom1")
    ...
    update() {
        ...
        if (character.x < 5) {
            this.scene.start("speedruntower1")
        }
    }
}